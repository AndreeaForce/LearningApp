            ...
            <div class="col__medium-8" id="profiles">
                <div class="profiles-content">
                    ...
                    <form id="insert-profile" class="insertProfile" action="/LearningApp/settings/profiles.php" method="POST">
                        ...
                        <input type="text" name="profileName" id="profile-name" class=""><br><br>
                        
                        <label for="profile-gender">Select Gender</label><br>
                        <select name="profileGender" id="profile-gender" class="">
                            <option value="Male">Male</option>
                            <option value="Female">Female</option>
                        </select><br><br>
                        
                        <label> Select Age</label><br>
                        <input type="number" name="profileAge" id="profile-age" class="" min="1" max="20"><br><br>
